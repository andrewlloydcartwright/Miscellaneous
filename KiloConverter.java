 ...
 *	Date:		11/3/2015
 *	Assignment:	03
 *	Objective:	Given the framework for a GUI Kilometer -> Mile converter, translate that into a
 *				GUI for a Celcius -> Fahrenheit converter.
 */
   ...
   */
   ...
   private class CalcButtonListener implements ActionListener
   {
      ...
      */
      ...
      {
         String tempCel;  // To hold the user's input
         double tempF;  // The number of miles

         // Get the text entered by the user into the
         // text field.
         tempCel = kiloTextField.getText();

         // For debugging, display the text entered, and
         // its value converted to a double.
         System.out.println("Reading " + tempCel +
                            " from the text field.");
         System.out.println("Converted value: " +
                            Double.parseDouble(tempCel));

         // Convert the input to miles.
         tempF = Double.parseDouble(tempCel);
         tempF = ((1.8 * tempF) + 32);

         // Display the result.
         JOptionPane.showMessageDialog(null, tempCel +
                  " degrees Celcius is " + tempF + " degrees Fahrenheit.");
